                        ...
                        <div key={index} className="bg-white rounded-[2rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden border border-gray-100 hover:shadow-[0_20px_40px_rgb(1,195,142,0.15)] hover:-translate-y-2 transition-all duration-300 group flex flex-col">
                            ...
                            <div className="p-6 flex flex-col flex-grow relative bg-white z-10">
                                ...
                                <div className="mt-auto flex space-x-3 pt-4 border-t border-gray-100">
                                    <button className="flex-1 flex items-center justify-center py-2.5 rounded-xl border border-gray-200 text-gray-500 hover:bg-[#25D366] hover:text-white hover:border-[#25D366] transition-all duration-300 active:scale-95 group/btn">
                                    ...
                                    <button className="flex-1 flex items-center justify-center py-2.5 rounded-xl border border-gray-200 text-gray-500 hover:bg-[#01c38e] hover:text-white hover:border-[#01c38e] transition-all duration-300 active:scale-95 group/btn">
